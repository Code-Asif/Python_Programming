...
questions = [
    ...
    ["compareTo() returns", "true", "flase", "An int value", "Nothing", "None", 3],
    [
    ...
    ["Total constructor string class have?", "3", "7", "13", "20", "None", 3],
    [
    ...
    ["Output of Math.floor(3.6)?", "3", "3.0", "4", "4.0", "None", 2],
    [
